...
const HERO_PATH = "/media/email-hero-sq.jpg";
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:${panel};border:1px solid rgba(201,163,92,0.25);border-radius:14px;overflow:hidden;">
        ...
        <tr><td style="padding:22px 26px 4px;text-align:center;">
          <img src="${heroUrl}" alt="EAGLE CLUB — Indoor Golf" width="240" style="width:100%;max-width:240px;height:auto;border-radius:12px;display:inline-block;border:0;outline:none;text-decoration:none;" />
        </td></tr>
